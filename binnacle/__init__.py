...
A twelfth console script, `binnacle`, comes with them and is not one of
...
--help on one page.  TOOLS below stays the eleven, because it is the map
of the instruments.
...
#: The eleven instruments, and what each answers.  The `binnacle` command
